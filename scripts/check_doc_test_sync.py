...
TARGET = Path(__file__).resolve().parent / "docs" / "check_doc_test_sync.py"
_original_name = __name__
_original_file = __file__

globals()["__name__"] = "scripts.check_doc_test_sync_proxy"
...
if __name__ == "__main__":
	print("[DEPRECATED] Use scripts/docs/check_doc_test_sync.py", file=sys.stderr)
