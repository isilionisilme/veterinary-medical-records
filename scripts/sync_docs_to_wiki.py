...
def main() -> int:
    ...
    # Apply index-style structure for Shared Documentation.
    ...
    if "## Governance" not in shared_index_body:
        shared_index_body = (
            shared_index_body.rstrip()
            + "\n\n## Governance\n\n"
            + "- Canonical sources live in `docs/shared/*`.\n"
            + "- This page is auto-generated by `scripts/sync_docs_to_wiki.py`.\n"
        )
