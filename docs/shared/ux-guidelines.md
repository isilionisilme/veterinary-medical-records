...
corresponding **project-level UX document** (e.g. [`docs/projects/veterinary-medical-records/01-design/ux-design.md`](../projects/veterinary-medical-records/01-design/ux-design.md)).
...
(e.g. [`docs/projects/veterinary-medical-records/01-design/ux-design.md`](../projects/veterinary-medical-records/01-design/ux-design.md)).
