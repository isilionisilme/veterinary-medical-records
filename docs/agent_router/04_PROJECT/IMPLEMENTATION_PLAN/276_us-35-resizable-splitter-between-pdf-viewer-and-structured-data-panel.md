...
- UX: Side-by-side review interaction baseline: [`docs/projects/veterinary-medical-records/01-design/ux-design.md`](../UX_DESIGN/00_entry.md) Sections 2–4.
- Product: Global Schema canonical ordering invariants: [`docs/projects/veterinary-medical-records/01-design/product-design.md`](../PRODUCT_DESIGN/00_entry.md) section **Global Schema (Canonical Field List)**.
