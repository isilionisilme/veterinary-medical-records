...
- Product: Learning and governance principles: [`docs/projects/veterinary-medical-records/01-design/product-design.md`](../PRODUCT_DESIGN/00_entry.md) Section 6
...
- UX: No explicit feedback flows: [`docs/projects/veterinary-medical-records/01-design/ux-design.md`](../UX_DESIGN/00_entry.md) Section 4
