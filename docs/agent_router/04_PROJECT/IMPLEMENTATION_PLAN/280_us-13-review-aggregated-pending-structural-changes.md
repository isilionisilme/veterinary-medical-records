...
- Product: Separation of responsibilities and governance boundary: [`docs/projects/veterinary-medical-records/design/PRODUCT_DESIGN.md`](../PRODUCT_DESIGN/00_entry.md) Sections 5 and 4.3
...
- Tech: Governance persistence + endpoints: [`docs/projects/veterinary-medical-records/tech/TECHNICAL_DESIGN.md`](../TECHNICAL_DESIGN/00_entry.md) Appendix B2.8–B2.9 + Appendix B3.1
