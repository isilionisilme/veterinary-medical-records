...
- Product: Critical concept policy: [`docs/projects/veterinary-medical-records/01-design/product-design.md`](../PRODUCT_DESIGN/00_entry.md) Section 4
...
- UX: Sensitive changes never add veterinarian friction: [`docs/projects/veterinary-medical-records/01-design/ux-design.md`](../UX_DESIGN/00_entry.md) Section 6
