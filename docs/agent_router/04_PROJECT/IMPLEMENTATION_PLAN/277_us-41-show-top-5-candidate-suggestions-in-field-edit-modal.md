...
- The standard review payload includes optional per-field `candidate_suggestions` as defined in [`docs/project/TECHNICAL_DESIGN.md`](../TECHNICAL_DESIGN/00_entry.md) section **Field Candidate Suggestions (standard review payload)**.
...
- [`docs/project/UX_DESIGN.md`](../UX_DESIGN/00_entry.md)
- [`docs/project/DESIGN_SYSTEM.md`](../DESIGN_SYSTEM/00_entry.md)
- [`docs/project/PRODUCT_DESIGN.md`](../PRODUCT_DESIGN/00_entry.md)
- [`docs/project/TECHNICAL_DESIGN.md`](../TECHNICAL_DESIGN/00_entry.md) section **Field Candidate Suggestions (standard review payload)**
