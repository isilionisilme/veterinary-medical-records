...
- Preserve existing observability contracts (events/metrics/log taxonomy) as defined in [`docs/project/TECHNICAL_DESIGN.md`](../TECHNICAL_DESIGN/00_entry.md).
- Follow implementation conventions in [`docs/project/BACKEND_IMPLEMENTATION.md`](../BACKEND_IMPLEMENTATION/00_entry.md) and [`docs/project/FRONTEND_IMPLEMENTATION.md`](../FRONTEND_IMPLEMENTATION/00_entry.md).
