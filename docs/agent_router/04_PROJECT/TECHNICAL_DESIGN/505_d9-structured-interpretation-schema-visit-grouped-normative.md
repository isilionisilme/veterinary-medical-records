...
- UX labels/copy are defined in [`docs/projects/veterinary-medical-records/design/ux-design.md`](../UX_DESIGN/00_entry.md); this appendix defines contract semantics only.
