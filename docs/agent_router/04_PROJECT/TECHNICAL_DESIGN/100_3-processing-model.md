...
This document describes an in-process execution model; story-specific scope boundaries live in [`docs/projects/veterinary-medical-records/delivery/IMPLEMENTATION_PLAN.md`](../IMPLEMENTATION_PLAN/00_entry.md).
