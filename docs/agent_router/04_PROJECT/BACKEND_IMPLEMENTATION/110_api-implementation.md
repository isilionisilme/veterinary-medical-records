...
- Endpoint map: [`docs/projects/veterinary-medical-records/tech/technical-design.md`](../TECHNICAL_DESIGN/00_entry.md) Appendix B3 (+ B3.1)
- Run resolution per endpoint: [`docs/projects/veterinary-medical-records/tech/technical-design.md`](../TECHNICAL_DESIGN/00_entry.md) Appendix B3.1
- Error response format: [`docs/projects/veterinary-medical-records/tech/technical-design.md`](../TECHNICAL_DESIGN/00_entry.md) Appendix B2.6
- Endpoint error semantics & error codes: [`docs/projects/veterinary-medical-records/tech/technical-design.md`](../TECHNICAL_DESIGN/00_entry.md) Appendix B3.2
...
Authority: [`docs/projects/veterinary-medical-records/tech/technical-design.md`](../TECHNICAL_DESIGN/00_entry.md) Appendix B3.2 (Conflict reasons and error semantics).
