...
Authority: [`docs/projects/veterinary-medical-records/tech/technical-design.md`](../TECHNICAL_DESIGN/00_entry.md) Appendix B2 (Minimal Persistent Data Model).
...
Authority: [`docs/projects/veterinary-medical-records/tech/technical-design.md`](../TECHNICAL_DESIGN/00_entry.md) Appendix A (Contracts, States & Invariants).
...
Authority: [`docs/projects/veterinary-medical-records/tech/technical-design.md`](../TECHNICAL_DESIGN/00_entry.md) Appendix A2 + Appendix B1.2.
...
Authority: [`docs/projects/veterinary-medical-records/tech/technical-design.md`](../TECHNICAL_DESIGN/00_entry.md) Appendix B1.2.1 (Persistence-Level Guard Pattern).
