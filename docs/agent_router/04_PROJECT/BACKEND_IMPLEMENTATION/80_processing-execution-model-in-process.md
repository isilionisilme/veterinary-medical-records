...
## Scheduler semantics
Authority: [`docs/projects/veterinary-medical-records/tech/technical-design.md`](../TECHNICAL_DESIGN/00_entry.md) Appendix B1.5 + B1.5.1.
...
Authority: [`docs/projects/veterinary-medical-records/tech/technical-design.md`](../TECHNICAL_DESIGN/00_entry.md) Appendix B1.3 + Appendix C3.

## Retry + timeout policy
Authority: [`docs/projects/veterinary-medical-records/tech/technical-design.md`](../TECHNICAL_DESIGN/00_entry.md) Appendix B1.4 + B1.4.1.
