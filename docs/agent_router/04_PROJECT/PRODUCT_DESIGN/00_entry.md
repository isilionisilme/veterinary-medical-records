...
- Global Schema historical/canonical ownership remains in `docs/projects/veterinary-medical-records/01-design/product-design.md`; router modules are derived convenience shards only.
