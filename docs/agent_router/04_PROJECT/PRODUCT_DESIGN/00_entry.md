...
- Global Schema historical/canonical ownership remains in `docs/projects/veterinary-medical-records/design/PRODUCT_DESIGN.md`; router modules are derived convenience shards only.
