...
| Source doc (inspected) | Diff inspected | Classification | Owner module(s) updated | Related tests/guards updated | Source→Router parity | Files modified |
|---|---:|---|---|---|---|
| docs/... | Yes/No | Rule change / Clarification / Navigation | docs/... (comma-separated) | path/to/test_or_guard.py (comma-separated) | Pass/Fail/Not mapped | docs/... (comma-separated) |
