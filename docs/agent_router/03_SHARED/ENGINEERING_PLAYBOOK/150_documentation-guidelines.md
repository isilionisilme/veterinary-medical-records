...
When asked to add a new User Story, update [`docs/projects/veterinary-medical-records/delivery/implementation-plan.md`](../../../projects/veterinary-medical-records/delivery/implementation-plan.md) in two places:
