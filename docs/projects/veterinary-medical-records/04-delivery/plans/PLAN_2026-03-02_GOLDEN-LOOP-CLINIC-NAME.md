...
- [ ] P0-A 🔄 — Baseline de `clinic_name`: crear/ajustar fixtures sintéticos + benchmark específico y medir accuracy inicial (GPT-5.3-Codex)
- [ ] P0-B 🔄 — Añadir regresiones mínimas (positivas/negativas) para patrones reales de encabezado y OCR ruidoso (GPT-5.3-Codex)
...
```text
P0-A 🔄 — Baseline de clinic_name: crear/ajustar fixtures sintéticos + benchmark específico y medir accuracy inicial.
```
