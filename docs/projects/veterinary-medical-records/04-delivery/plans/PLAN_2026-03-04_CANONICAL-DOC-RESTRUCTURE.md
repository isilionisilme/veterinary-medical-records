...
- [ ] F2-B 🚧 — **Delete `engineering-playbook.md`** — Sustituido por coding-standards + documentation-guidelines + way-of-working. Commit C7. (Claude Opus 4.6) ⏳ EN PROGRESO (Claude Opus 4.6, 2026-03-04)
