...
Implementation note (2026-03-11): `ADR-ARCH-0005` was already used by complexity gate thresholds, so the missing
ADRs for this item were recorded as `0006` and `0007`.
