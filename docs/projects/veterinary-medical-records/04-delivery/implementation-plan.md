...
1. **Field label changes (display-only)**
...
1. The reviewer sees “NHC” with tooltip “Número de historial clínico”.
2. If NHC is expected but no value is available, the reviewer still sees the NHC row with placeholder “—”.
3. In “Propietario”, “Dirección” shows an address value; identifier-like values are not presented as addresses.
4. The reviewer sees “Otros campos detectados” as a separate section for additional detected data.
5. The reviewer sees “Visitas” grouped by visit, without mixed data between different visits.
...
1. Assignment of visit-scoped fields
...
1. No structural scoping regression
...
1. **Transparency when evidence is insufficient**
...
1. **Measurable improvement (fixture-bound + frozen baseline)**
...
**Non-user-facing guardrails (testable)** 5) **No new visits created**
...
1. Clear evaluator run instructions
