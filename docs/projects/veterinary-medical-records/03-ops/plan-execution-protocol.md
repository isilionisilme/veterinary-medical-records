...
- [Plan Execution Protocol](#plan-execution-protocol)
  ...
  - [7. Plan Governance](#7-plan-governance)
    ...
    - [Approval Enforcement (Execution-Time)](#approval-enforcement-execution-time)
    - [Pull Request progress tracking (mandatory)](#pull-request-progress-tracking-mandatory)
    ...
    - [Agent Availability Selection (Mandatory Plan-Start Choice)](#agent-availability-selection-mandatory-plan-start-choice)
  ...
  - [13. SCOPE BOUNDARY Procedure (Two-Commit Strategy for Commit Tasks)](#13-scope-boundary-procedure-two-commit-strategy-for-commit-tasks)
  ...
  - [14. Iteration Lifecycle Protocol](#14-iteration-lifecycle-protocol)
    ...
    - [Draft PR Creation (On First Push)](#draft-pr-creation-on-first-push)
