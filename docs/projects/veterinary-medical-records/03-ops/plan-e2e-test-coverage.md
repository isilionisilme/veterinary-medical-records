...
- [Objetivo](#objetivo)
- [1. Inventario de funcionalidades (perspectiva del usuario)](#1-inventario-de-funcionalidades-perspectiva-del-usuario)
  - [A — Carga de la aplicación](#a--carga-de-la-aplicaci%C3%B3n)
  - [B — Sidebar de documentos](#b--sidebar-de-documentos)
  - [C — Upload de documentos](#c--upload-de-documentos)
  - [D — Visor PDF](#d--visor-pdf)
  - [E — Toolbar del visor (pestañas)](#e--toolbar-del-visor-pesta%C3%B1as)
  - [F — Vista de texto extraído (Raw Text)](#f--vista-de-texto-extra%C3%ADdo-raw-text)
  - [G — Detalles técnicos (historial de procesamiento)](#g--detalles-t%C3%A9cnicos-historial-de-procesamiento)
  - [H — Panel de datos extraídos (Structured Data)](#h--panel-de-datos-extra%C3%ADdos-structured-data)
  - [I — Búsqueda y filtros en datos extraídos](#i--b%C3%BAsqueda-y-filtros-en-datos-extra%C3%ADdos)
  - [J — Edición de campos](#j--edici%C3%B3n-de-campos)
  - [K — Workflow de revisión](#k--workflow-de-revisi%C3%B3n)
  - [L — Panel de evidencia (Source Panel)](#l--panel-de-evidencia-source-panel)
  - [M — Layout y split panel](#m--layout-y-split-panel)
  - [N — Toasts y notificaciones](#n--toasts-y-notificaciones)
  - [O — Visitas (contrato canónico)](#o--visitas-contrato-can%C3%B3nico)
- [2. Especificación detallada de tests (Given / When / Then)](#2-especificaci%C3%B3n-detallada-de-tests-given--when--then)
  ...
  - [P2 — Features secundarias (nightly / pre-release, <90 s cada test)](#p2--features-secundarias-nightly--pre-release-90-s-cada-test)
...
- [3. Estrategia de ejecución](#3-estrategia-de-ejecuci%C3%B3n)
  - [En cada PR (CI `e2e` job)](#en-cada-pr-ci-e2e-job)
  - [Nightly / pre-release](#nightly--pre-release)
  - [Configuración técnica](#configuraci%C3%B3n-t%C3%A9cnica)
  - [Scripts npm propuestos](#scripts-npm-propuestos)
- [4. Fixtures y helpers necesarios](#4-fixtures-y-helpers-necesarios)
- [5. `data-testid` adicionales necesarios](#5-data-testid-adicionales-necesarios)
- [6. Cobertura por capa](#6-cobertura-por-capa)
  - [Matriz de trazabilidad Test → Funcionalidad](#matriz-de-trazabilidad-test-%E2%86%92-funcionalidad)
- [7. Orden de implementación recomendado](#7-orden-de-implementaci%C3%B3n-recomendado)
