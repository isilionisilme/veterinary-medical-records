...
AI-assisted processing of veterinary clinical records — extracting, structuring, and presenting medical data from PDF documents.
...
- [frontend-implementation.md](02-tech/frontend-implementation.md) — frontend implementation notes.
...
- [future-improvements.md](04-delivery/future-improvements.md) — roadmap with prioritized next steps.
- [Active plans](04-delivery/plans/) — current implementation plans.
