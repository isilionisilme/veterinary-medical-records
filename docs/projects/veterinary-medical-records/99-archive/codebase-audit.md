...
| Dead Code / Redundancy  | 62/100 | Partial      | frontend/src/lib/processingHistory.test.ts, frontend/src/lib/**tests**/processingHistory.test.ts                      | Test duplication introduces maintenance drag and divergence risk.                                                                    |
...
|   8 | Dead Code / Test hygiene    | frontend/src/lib/processingHistory.test.ts and frontend/src/lib/**tests**/processingHistory.test.ts | Consolidate overlapping tests.                                                                                     | Low effort, quick maintainability win.                                   | S              | Single canonical test set remains with equivalent assertions.                       |
