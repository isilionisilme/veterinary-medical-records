...
- Branch `fix/golden-discharge-date-iteration` | Commit `cb95be5e` | PR: TODO(PR: pending) | docA missing→accepted (`2024-07-20`).
- Commit `c27b2e14` | PR: TODO(PR: pending) | promotion includes discharge_date when canonical is missing.
