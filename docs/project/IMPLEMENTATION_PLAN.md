...
- Document status indicators are unified through a reusable `DocumentStatusCluster` used consistently in the document list/sidebar and active review header area.
...
- Add and adopt `DocumentStatusCluster` for consistent document status rendering in sidebar and review header.
...
- Unified Document Status Cluster renders consistent status semantics in sidebar and active review header.
