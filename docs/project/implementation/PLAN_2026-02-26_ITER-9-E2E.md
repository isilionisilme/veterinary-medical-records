...
- [ ] F15-K 🚧 — FUTURE_IMPROVEMENTS refresh + smoke test (Claude)
...
## Progress
- [ ] F15-A — data-testid attributes
- [ ] F15-B — E2E: upload flow
- [ ] F15-C — E2E: review flow
- [ ] F15-D — E2E: edit flow
- [ ] F15-E — E2E: mark reviewed
- [ ] F15-F — DELIVERY_SUMMARY refresh
- [ ] F15-G — TECHNICAL_DESIGN refresh
- [ ] F15-H — README E2E section
- [ ] F15-I — cli.py tests
- [ ] F15-J — Docker healthcheck
- [ ] F15-K — FUTURE_IMPROVEMENTS + smoke"
```
