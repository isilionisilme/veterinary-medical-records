...
- Load: `docs/projects/veterinary-medical-records/ops/execution-rules.md`.
- **Step completion integrity:** before any handoff or auto-chain, enforce § "Step completion integrity" (NO-BATCH, CI-FIRST-BEFORE-HANDOFF, PLAN-UPDATE-IMMEDIATO, STEP-LOCK, EVIDENCE BLOCK, AUTO-HANDOFF GUARD).- **Iteration close:** after merge, execute § "Iteration close-out protocol" in `execution-rules.md` (reconciliation, IMPLEMENTATION_HISTORY, DOC_UPDATES normalization).- Active plans: `docs/projects/veterinary-medical-records/delivery/plans/PLAN_*.md`; completed: `docs/projects/veterinary-medical-records/delivery/plans/completed/`.
