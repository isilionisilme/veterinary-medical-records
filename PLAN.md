...
- Story 1 functionality landed on `main` as commit `914470d` ("Story 1: Add document upload baseline", 2026-01-30) before the repo adopted the "one PR per user story" workflow.  
