...
# ADR-sqlite-database: SQLite as Primary Database

## Context

The system persists document metadata, processing run state, review artifacts, and calibration aggregates for a
single-clinic operational context. The exercise requires a fast Docker-first setup with minimal infrastructure and high
