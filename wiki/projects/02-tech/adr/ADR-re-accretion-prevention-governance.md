# ADR-re-accretion-prevention-governance: Re-accretion Prevention Governance
...
- Mitigation: treat this ADR as the source of truth for architecture budgets
  and treat ADR-complexity-gate-thresholds as the enforcement implementation detail.
